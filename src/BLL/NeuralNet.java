...
public class NeuralNet {
        ...
        try
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    neuralNet.save("D:\\Final Project\\FaceRecognition_Payroll\\Neuroph\\NewNeuralNetwork.nnet");
    ...
    public int recognizeFaces(double[] testImage,int outputsize)
    {
        ...
        try
        {
            ...
            NeuralNetwork neural=NeuralNetwork.load("D:\\Final Project\\FaceRecognition_Payroll\\Neuroph\\NewNeuralNetwork.nnet");
